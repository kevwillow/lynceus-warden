-- Reverse of 019_watchlist_ssid_pattern.sql.
--
-- 019 relaxed watchlist.pattern_type CHECK to admit 'ssid_pattern'.
-- The reverse tightens the CHECK back to the post-013 set. Carries
-- the post-013 columns (mac_range_prefix, mac_range_prefix_length)
-- and the partial index across the rebuild.
--
-- Conditional reverse. If any row with pattern_type='ssid_pattern'
...
ALTER TABLE watchlist_pre019 RENAME TO watchlist;
